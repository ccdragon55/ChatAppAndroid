...
//    }
    ...
    public ChatMessage(Map<String, Object> map) {
        ...
        this.messageId = (messageIdValue instanceof Long) ? ((Long) messageIdValue).intValue() : 0;
        this.sessionId = Objects.toString(map.get("sessionId"), "");
        Object messageTypeValue = map.getOrDefault("messageType", 0);
        this.messageType = (messageTypeValue instanceof Long) ? ((Long) messageTypeValue).intValue() : 0;
        this.messageContent = Objects.toString(map.get("messageContent"), "");
        ...
        this.sendUserId = Objects.toString(map.get("sendUserId"), "");
        this.sendUserNickName = Objects.toString(map.get("sendUserNickName"), "");
        Object sendTimeValue = map.getOrDefault("sendTime", 0);
        this.sendTime = (sendTimeValue instanceof Long) ? (long) sendTimeValue : 0;
        Object statusValue = map.getOrDefault("status", 0);
        this.status = (statusValue instanceof Long) ? ((Long) statusValue).intValue() : 0;
        Object fileSizeValue = map.getOrDefault("fileSize", 0);
        this.fileSize = (fileSizeValue instanceof Long) ? (long) fileSizeValue : 0;
        this.fileName = Objects.toString(map.get("fileName"), "");
        this.filePath = Objects.toString(map.get("filePath"), "");
        Object fileTypeValue = map.getOrDefault("fileType", 0);
        this.fileType = (fileTypeValue instanceof Long) ? ((Long) fileTypeValue).intValue() : 0;
        this.url = Objects.toString(map.get("url"), "");
